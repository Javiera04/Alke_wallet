...
/**
 * La clase 'CuentaCLP' es una clase hija de {@link Cuenta}.
 * Es la encargada de generar los depositos y retiros de la cuenta.
 * Además, incluye el simbolo de la moneda asignada a esta clase(CLP),
 * el factor de conversión que se utiliza para pasar de CLP a USD y
 * la operación que hace esto posible.
 * 
 */
public class CuentaCLP extends Cuenta{

	/**
	 * super constructor de la clase 'CuentaCLP'
	 ...
	 * se interpreta como peso chileno
	 */
	public CuentaCLP(int numeroDeCuenta, double saldoActual) {
	...
	public double getFactorConversion() {
		return 958.522; //factor de conversion el 21-04-2024
	}

	@Override
	public double convertir(double monto) {
		return Math.round((monto/getFactorConversion())*100)/100d;
	}
